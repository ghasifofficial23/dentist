...
export const AdminDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-bg-light flex">
      {/* Sidebar */}
      <aside className={cn(
        "fixed inset-y-0 left-0 z-50 bg-white border-r border-deep/5 transition-all duration-500",
      ...
      <main className={cn(
        ...
        <header className="sticky top-0 z-30 bg-bg-light/80 backdrop-blur-md px-10 py-6 flex justify-between items-center">
          <div>
            <h1 className="text-2xl font-display font-black text-deep">{activeTab}</h1>
          ...
          <div className="flex items-center gap-6">
            ...
            <button 
              ...
              className="p-3 bg-white border border-deep/5 rounded-2xl text-deep hover:bg-primary hover:text-white transition-all shadow-sm"
            >
